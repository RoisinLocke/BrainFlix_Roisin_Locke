        ...
        return (
            <div className="video">
                ...
                <div className="video__controls">
                    ...
                    <button className="video__play" type="button" data-state="play" onClick={this.playHandler}>
                        <img className="video__play--svg" src="Assets/Icons/SVG/Icon-play.svg" alt="Play Button"/>
                        <img className="video__pause--svg" src="Assets/Icons/SVG/Icon-pause.svg"/>
                    </button>
                    {/* <button className="video__pause" type="button" data-state="pause" onClick={this.pauseHandler}> </button> */}
